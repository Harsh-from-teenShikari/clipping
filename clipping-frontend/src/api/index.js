...
export const campaignsAPI = {
  ...
  update: (id, body) =>
    api.patch(`/campaigns/${id}`, body),

  activate: (id) =>
    api.patch(`/campaigns/${id}/activate`),
...
export const submissionsAPI = {
  ...
  getPassed: (campaignId) =>
    api.get(`/submissions/passed/${campaignId}`),
...
export const identityAPI = {
  getDashboard: (creatorId) =>
    api.get(`/identity/dashboard/${creatorId}`),
}
